...
<%
    ...
    sql1="select * from info_game where (ig_anal IS NULL or ig_anal='') and ig_event='N' and (ig_status<>'F' and ig_status<>'C') and (rl_sports = '축구' or rl_sports = '야구' or rl_sports='농구' or rl_sports='아이스하키') order by ig_starttime desc"
