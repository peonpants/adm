...
<%
	...
	Call dfgameSql.RetrieveInfo_Betting_Static(dfDBConn.Conn,  page, pageSize, Search, Find, sStartDate, sEndDate, site, reqIB_AMOUNT)
...
<tr bgcolor="eeeeee"> 
	...
	<td align="center" width="160"><b>배팅시간</b></td>		
...
<%
	...
	FOR ii = 0 TO dfgameSql.RsCount -1
		...
		CNT_1 = dfgameSql.Rs(ii,"CNT_1")
		CNT_2 = dfgameSql.Rs(ii,"CNT_2")
		GOOD_CNT_1 = dfgameSql.Rs(ii,"GOOD_CNT_1")
		GOOD_CNT_2 = dfgameSql.Rs(ii,"GOOD_CNT_2")
		...
		IF ii = 0 THEN
		    RESPONSE.Write "1폴더 전체 : " & CNT_1 & " 적중 :" & GOOD_CNT_1& "<BR> 2폴더 전체 : " & CNT_2  & " 적중 :" & GOOD_CNT_2
		END IF
		%>
