...
<%
    ...
    sql1="select * from info_game where (ig_anal IS NULL or ig_anal='') and ig_event is not null and rl_sports = '실시간' and (ig_status<>'F' and ig_status<>'C') order by ig_starttime desc"
