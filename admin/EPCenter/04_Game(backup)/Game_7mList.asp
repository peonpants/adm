...
<tr bgcolor="<%= bgColor %>" height="25" class="<%= trClass %>" useAtt="<%= trClass2 %>" style="display:block"> 
    ...
    <input type="CheckBox" name="IG_Type02" value="Yes" onclick="showHideLayer('divHandi<%= ii %>');"> 핸디캡
    ...
    <td>
    <% IF dfGameSql.Rs(ii,"IG_TYPE") = 0 AND  dfGameSql.Rs(ii,"IG_IDX") = "" Then %>
    <input type="CheckBox" name="IG_Type03" value="Yes" onclick="showHideLayer('divOver<%= ii %>');"> 오버언더
