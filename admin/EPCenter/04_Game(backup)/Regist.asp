...
<tr>
	...
	<td bgcolor="FF9600" align="center" width="150"><b>스페셜Y/N</b></td>
	<td ><input type="CheckBox" name="IG_SP<%= i %>" value="Y"></td>		    	
</tr></table>
	
<table border="1" bordercolorlight="#bebebe" cellspacing="0" cellpadding="0" bordercolordark="#FFFFFF" width="95%">
<tr><td bgcolor="e7e7e7" align="center" width="150"><b>홈 팅 명</b></td>
	<td width="250"><input type="text" name="IG_Team1<%= i %>" class="input" maxlength="50"></td>
	<td bgcolor="e7e7e7" align="center" width="150"><b>원정팀명</b></td>
	<td width="250"><input type="text" name="IG_Team2<%= i %>" class="input" maxlength="50"></td></tr></table>

<table width="95%" border="0" cellpadding="2" cellspacing="1" bgcolor="#C8C8C8">
<tr bgcolor="#ECECEC">
...
<tr bgcolor="#FFFFFF">
	<td><input type="CheckBox" name="IG_Type01<%= i %>" value="Yes"> 승무패</td>
	<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr><td>승(배당)</td>
			<td align="right"><input type="text" name="01_Bet<%= i %>" id="01_Bet<%= i %>" class="input" style="width:60px;"  onkeyup='betPercent("01_Bet<%= i %>","02_Bet<%= i %>","03_Bet<%= i %>","percent_0_<%= i %>",0)'></td></tr></table></td>
	<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr><td>무(배당)</td>
			<td align="right"><input type="text" name="02_Bet<%= i %>" id="02_Bet<%= i %>" class="input" style="width:60px;"  onkeyup='betPercent("01_Bet<%= i %>","02_Bet<%= i %>","03_Bet<%= i %>","percent_0_<%= i %>",0)'></td></tr></table></td>
	<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr><td>패(배당)</td>
			<td align="right"><input type="text" name="03_Bet<%= i %>" id="03_Bet<%= i %>" class="input" style="width:60px;"  onkeyup='betPercent("01_Bet<%= i %>","02_Bet<%= i %>","03_Bet<%= i %>","percent_0_<%= i %>",0)'></td></tr></table></td>
	<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr><td>요율</td>
...
<tr bgcolor="#FFFFFF">
	<td><input type="CheckBox" name="IG_Type02<%= i %>" value="Yes"> 핸디캡</td>
	<td>
	    <table border="0" cellpadding="0" cellspacing="0" width="100%">
		    <tr>
		        <td style="cursor:pointer" onclick='betValue("04_Bet<%= i %>","hoBet")'>핸디승(배당)</td>
			    <td align="right"><input type="text" name="04_Bet<%= i %>" id="04_Bet<%= i %>" class="input" style="width:60px;" onkeyup='betPercent("04_Bet<%= i %>",0,"06_Bet<%= i %>","percent_1_<%= i %>",1)'></td>
			</tr>
		</table>
	</td>
	<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr><td style="cursor:pointer" onclick='betValue("05_Bet<%= i %>","handiCnt")'>핸디캡</td>
			<td align="right"><input type="text" name="05_Bet<%= i %>" id="05_Bet<%= i %>" class="input" style="width:60px;" ></td></tr></table></td>
	<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr><td style="cursor:pointer"  onclick='betValue("06_Bet<%= i %>","hoBet")'>핸디패(배당)</td>
			<td align="right"><input type="text" name="06_Bet<%= i %>" id="06_Bet<%= i %>" class="input" style="width:60px;" onkeyup='betPercent("04_Bet<%= i %>",0,"06_Bet<%= i %>","percent_1_<%= i %>",1)'></td></tr></table></td>
	<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr><td>요율</td>
...
<tr bgcolor="#FFFFFF">
	<td><input type="CheckBox" name="IG_Type03<%= i %>" value="Yes"> 오버언더</td>
	<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr><td style="cursor:pointer" onclick='betValue("07_Bet<%= i %>","hoBet")'>오버(배당)</td>
			<td align="right"><input type="text" name="07_Bet<%= i %>"  id="07_Bet<%= i %>" class="input" style="width:60px;" onkeyup='betPercent("07_Bet<%= i %>",0,"09_Bet<%= i %>","percent_2_<%= i %>",2)'></td></tr></table></td>
	<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr><td style="cursor:pointer"  onclick='betValue("08_Bet<%= i %>","overCnt")'>합산</td>
			<td align="right"><input type="text" name="08_Bet<%= i %>" id="08_Bet<%= i %>" class="input" style="width:60px;"></td></tr></table></td>
	<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr><td style="cursor:pointer"  onclick='betValue("09_Bet<%= i %>","hoBet")'>언더(배당)</td>
			<td align="right"><input type="text" name="09_Bet<%= i %>" id="09_Bet<%= i %>" class="input" style="width:60px;" onkeyup='betPercent("07_Bet<%= i %>",0,"09_Bet<%= i %>","percent_2_<%= i %>",2)'></td></tr></table></td>
	<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr><td>요율</td>
...
<tr bgcolor="#FFFFFF">
	<td><input type="CheckBox" name="IG_Type04<%= i %>" value="Yes"> 점수맞추기</td>
	<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr><td style="cursor:pointer" >0~1골</td>
			<td align="right"><input type="text" name="10_Bet<%= i %>" class="input" style="width:60px;" class="input"></td></tr></table></td>
	<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr><td style="cursor:pointer"  >2~3골</td>
			<td align="right"><input type="text" name="11_Bet<%= i %>" class="input" style="width:60px;" class="input"></td></tr></table></td>
	<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr><td style="cursor:pointer"  >4~6골</td>
			<td align="right"><input type="text" name="12_Bet<%= i %>" class="input" style="width:60px;" class="input"></td>
			</tr></table></td>
	<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr><td>7골</td>
			<td align="right"><input type="text" name="13_Bet<%= i %>" class="input" style="width:60px;" class="input"></td>
	<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
