...
<div style="color:red">보기항목의 4번째항목은 크로스사이트에만 적용됩니다</div>
<div style="color:red">인덱스번호는 기준사이트의 경기인덱스 번호로 참고용이며 수정,삭제시 동일경기가 재등록되므로 주의하시기 바랍니다</div>
<div style="color:red">실시간항목은 배팅가능(S)에선 경기가 보이질 않습니다(사다리,파워볼,로하이,달팽이,지에스볼)</div>
<script>
