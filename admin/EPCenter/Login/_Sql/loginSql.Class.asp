<%
	...
	Class LoginSql
		...
		'Public Function GetINFO_ADMIN(ByRef pConn, IA_ID,strIP)
                
		'	mDBMng.StoredProc = "dbo.UP_GetINFO_ADMIN"
			
		'	mDBMng.SetParamVarWChar  	1,	IA_ID
		'	mDBMng.SetParamVarWChar  	2,	strIP	
		...
		Public Function GetINFO_IPCHK(ByRef pConn, strIP)
                
			mDBMng.StoredProc = "dbo.UP_GetINFO_IPCHK"
			
			mDBMng.SetParamVarWChar  	1,	strIP	
					
            GetINFO_IPCHK = mDBMng.Patch (pConn)
