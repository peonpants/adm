...
<%
	...
	IF dfeventSql.RsCount <> 0 Then
	    For ii = 0 to dfeventSql.RsCount - 1
            ...
            'IGIU_RESULT ="00"
	        UPSQL = "INSERT INTO INFO_GAME_INNING_USER (IGI_IDX, IGIU_NAME, IGIU_RESULT, IGIU_CONTENT, IGIU_REGDATE) VALUES ("&IGI_IDX&",'"& dfeventSql.Rs(ii,"IU_NICKNAME") &"', '"&IGIU_RESULT&"', '쿼터별이벤트는 나의것!! ','"&IGIU_REGDATE&"')"
