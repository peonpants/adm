...
<%
    For ii = 0 to dfeventSql.RsCount - 6
%>  
    <td>
...
<%
    ...
    IF dfeventSql1.RsCount <> 0 Then
        For ii = 0 to dfeventSql1.RsCount - 1
            ...
            Else
                userBgColor = "#69A0D2"
                IF dfeventSql1.Rs(ii,"IGIU_IP") = "125.187.40.192" Then
                    userBgColor = "#FFFFFF"
                End IF                
            End IF
%>        
        ...
        <%
           ...
           FOR jj = 1 to 5 'Len(dfeventSql1.Rs(ii,"IGIU_RESULT"))                
        ...
        <td><%= dfStringUtil.GetFullDate(dfeventSql1.Rs(ii,"IGIU_REGDATE")) %></td>
