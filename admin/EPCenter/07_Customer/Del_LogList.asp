...
<%
	...
	Call dfcustomerSql.RetrieveBoard_DelCustomer(dfDBConn.Conn,  page, pageSize, Search, Find, sStartDate, sEndDate , BC_Type)
    'dfcustomerSql.debug
...
<tr>
    <td><b class="text07"> 고객센터 삭제로그</b></td>
</tr>
</table>    
<div style="height:10px;"></div>

<table border="0" cellpadding="0" cellspacing="0" align="center">
<form name="MainForm" method="get" action="del_logList.asp">
<tr>
    <td>타입 :</td><td>
    <select name="BC_Type" onchange="location.href='del_logList.asp?BC_Type='+this.value">
