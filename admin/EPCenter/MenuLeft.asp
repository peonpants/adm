...
<tr>
    ...
    <tr id="tr1">
	    ...
	    <table width="100%" border="0" cellspacing="0" cellpadding="1" >
            ...
            <tr>
                <td height="15"> 		    
		            <a href="/EPCenter/04_Game/Betting_List.asp" target="ViewFrm" style="color:#000000; ">- 배팅리스트(전체)</a>
		        </td>
            </tr>
			<tr>
                <td height="15"> 		    
		            <a href="/EPCenter/04_Game/Betting_LiveList.asp" target="ViewFrm" style="color:#000000; ">- 배팅리스트(진행중)</a>
		        </td>
            </tr>
            <tr>
                <td height="15"> 		    
		            <a href="/EPCenter/04_Game/Betting_List1.asp" target="ViewFrm" style="color:#000000; ">- 배팅리스트(스포츠)</a>
		        </td>
            </tr>
			<tr>
                <td height="15"> 		    
		            <a href="/EPCenter/04_Game/BettingSadari_List.asp" target="ViewFrm" style="color:#000000; ">- 배팅리스트(실시간)</a>
		        </td>
            </tr>
			
			<tr>
                <td height="15"> 		    
		            <a href="/EPCenter/04_Game/BettingSadariRefresh_List.asp" target="ViewFrm" style="color:#000000; ">- 배팅리스트(실시간:새로고침)</a>
		        </td>
            </tr>
			<!--<tr>
                <td height="15"> 		    
		            <a href="/EPCenter/04_Game/BettingSadariRefresh_List1.asp" target="ViewFrm" style="color:#000000; ">- 배팅리스트(사다리:새로고침)</a>
		        </td>
            </tr>
			<tr>
                <td height="15"> 		    
		            <a href="/EPCenter/04_Game/BettingSadariRefresh_List2.asp" target="ViewFrm" style="color:#000000; ">- 배팅리스트(파워볼:새로고침)</a>
		        </td>
            </tr>
			<tr>
                <td height="15"> 		    
		            <a href="/EPCenter/04_Game/BettingSadariRefresh_List3.asp" target="ViewFrm" style="color:#000000; ">- 배팅리스트(다리다리:새로고침)</a>
		        </td>
            </tr>
			<tr>
                <td height="15"> 		    
		            <a href="/EPCenter/04_Game/BettingSadariRefresh_List4.asp" target="ViewFrm" style="color:#000000; ">- 배팅리스트(달팽이:새로고침)</a>
		        </td>
            </tr>
			<tr>
                <td height="15"> 		    
		            <a href="/EPCenter/04_Game/BettingSadariRefresh_List6.asp" target="ViewFrm" style="color:#000000; ">- 배팅리스트(MGM:새로고침)</a>
		        </td>
            </tr>
			<tr>
                <td height="15"> 		    
		            <a href="/EPCenter/04_Game/BettingSadariRefresh_List5.asp" target="ViewFrm" style="color:#000000; ">- 배팅리스트(가상축구:새로고침)</a>
		        </td>
            </tr>-->
			<tr>
				<td height="15">        
					<a href="/EPCenter/01_cp/blockip.asp" target="ViewFrm" style="color:#000000; ">- 관리자아이피관리</a>
				</td>
			</tr>  
		</tr>	   
        </table>		    
    ...
    <tr id="tr6">  
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="1" >
			...
			<tr>
                <td height="15">  	    
		            <a href="/EPCenter/05_Account/Charge_DelList.asp" target="ViewFrm" style="color:#000000; ">- 충전 삭제로그</a>
                </td>
            </tr> 
            <tr>
                <td height="15"> 		    
			...
			<tr>
                <td height="15">  	    
		            <a href="/EPCenter/05_Account/Exchange_DelList.asp" target="ViewFrm" style="color:#000000; ">- 환전 삭제로그</a>
                </td>
            </tr> 
            <tr>
                <td height="15"> 		    
            ...
            <tr>
                <td height="15"> 		    
		            <a href="/EPCenter/05_Account/Money_Addadmin_new.asp" target="ViewFrm" style="color:#000000; ">- 지사/총판 실시간정산</a>
                </td>
            </tr>
            <tr>
                <td height="15"> 		    
		            <a href="/EPCenter/05_Account/Money_Addadmin.asp" target="ViewFrm" style="color:#000000; ">- 지사/총판 롤링정산로그</a>
                </td>
            </tr>   			
            <tr>
                <td height="15"> 		    
			...
			<tr>
                <td height="15"> 		    
		            <a href="/EPCenter/05_Account/CashAccountMonth.asp" target="ViewFrm" style="color:#000000; ">- 날짜별현황(New)</a>
		        </td>
            </tr>
			<tr>
                <td height="15"> 		    
		            <a href="/EPCenter/05_Account/CashCalMonth.asp" target="ViewFrm" style="color:#000000; ">- 정산현황</a>
		        </td>
            </tr>
    ...
    <tr id="tr7">  
        ...
        <tr>
            <td height="15">        
                <a href="/EPCenter/10_Board/Board_List.asp?BF_LEVEL=1" target="ViewFrm" style="color:#000000; ">- 공지사항</a>
            </td>
        </tr>
	    <tr>
            <td height="15"> 			
	            <a href="/EPCenter/10_Board/Board_List.asp?BF_LEVEL=2" target="ViewFrm" style="color:#000000; ">- 이벤트</a>
            </td>
        </tr>         
        <tr>
            <td height="15">        
		...
		<tr>
            <td height="15">        
                <a href="/EPCenter/08_Board/Board_List.asp?BF_LEVEL=4" target="ViewFrm" style="color:#000000; ">- 스포츠공지</a>
            </td>
        </tr> 
		<tr>
            <td height="15">        
                <a href="/EPCenter/08_Board/Board_List.asp?BF_LEVEL=5" target="ViewFrm" style="color:#000000; ">- 실시간공지</a>
            </td>
        </tr> 		
        <tr>
            <td height="15">        
        ...
        <tr>
			...
			<tr>
                <td height="15"> 			
		            <a href="/EPCenter/07_Customer/Del_LogList.asp" target="ViewFrm" style="color:#000000; ">- 고객센터 삭제로그</a>
                </td>
            </tr> 
			<tr>
                <td height="15"> 			
		            <a href="/EPCenter/07_Customer/memoReadYn_List.asp" target="ViewFrm" style="color:#000000; ">- 쪽지확인여부</a>
                </td>
            </tr> 
            <tr>
                <td height="15"> 			
