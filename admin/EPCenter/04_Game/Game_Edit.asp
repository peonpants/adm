...
<%
	...
	SQLMSG = "SELECT *, CONVERT(VARCHAR, IG_STARTTIME, 111) + ' ' + CONVERT(VARCHAR(5), IG_STARTTIME, 114) AS IG_STARTTIME FROM INFO_GAME WHERE IG_IDX = '"& IG_IDX &"' "
...
<form name="frm1" action="Game_Edit_Proc.asp">
...
<tr><td width="20%" align="center"><%=RL_League%></td>
	...
	<%next%></select>분<input type="text" name="s_sec" style="width:70px;">초</td></tr></table>
...
<tr><td align="center">
	<input type="button" value="&nbsp;수&nbsp;정&nbsp;" style="height:18px;border:1px solid #999999;" onclick="FrmChk();"></td></tr></table></form>
