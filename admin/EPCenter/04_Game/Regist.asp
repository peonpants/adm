...
' 2017-08-06
' 게임구분 전체선택 체크박스 만들기
' line 47  = jquery-1.4.1.min.js  사용
' line 257~281 =  등록게임리스투수 갯수만큼  jquery 추가
' line 312 = <div ... 추가
' line 315 = td 추가 
' line 317 = <input type="checkbox" id="chkAll<% = i % >"><em>전체선택</em>
' line 596 = </div>
' 
'=================================================================================   홍실장
...
<% '=================================================================================== 홍 %>
	<td width="70" align="left">
		<input type="checkbox" id="chkAll<%= i %>"><em>전체선택</em></td>
<% '=================================================================================== 홍 %>
