...
<%
  IG_SITE = REQUEST("IG_SITE")
	...
	'IG_SITE = "All"
    HostPath = "G:\_drama\wwwAdmin\UpFile\Upload\"
	...
	If Not oRs.EOF Then
		...
		If oRs(0) <> "" AND oRs(1) <> "" AND oRs(2) <> "" then
            ...
            IG_TEAM1BET_CNT = cInt(IG_TEAM2BENEFIT * 10)
            IG_TEAM2BET_CNT = cInt(IG_TEAM1BENEFIT * 10)	        
	        ...
	        SQL = SQL & "IG_Type, IG_VSPoint, IG_Memo, IG_SITE, IG_SP) VALUES ( "
	        SQL = SQL & RL_Idx & ", '"
	        SQL = SQL & SRS_Sports & "', '"
	        SQL = SQL & RL_LEAGUE & "', '"
	        SQL = SQL & RL_IMAGE & "', '"
...
'---
	...
	xlDb3.Open "Provider=Microsoft.Jet.OLEDB.4.0; Data Source=G:\_drama\wwwAdmin\UpFile\Upload\"&FileName&"; Extended Properties=Excel 8.0;"
