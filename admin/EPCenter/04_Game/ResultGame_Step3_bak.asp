        ...
        IF cStr(Trim(IB_IDX)) <> cStr(Trim(dfgameSql(ii+1,"IB_IDX")))  Then        
            ...
            IF totalIBD_RESULT <> 9 Then
                ...
                IF totalIBD_RESULT = 0 Then      
                    ...
                    response.write IG_IDX & "<font color='blue'>낙첨 - " & IU_NICKNAME & "님 배팅금 : " & IB_Amount & "원 - 낙첨포인트 : "& IB_CASHBACK & "  -추천인("&RECOM_ID&") 지급액 :" & IB_RECOM_CASHBACK & "</font><br>" 
                ...
                Else
                    ...
                    IF  cStr(IU_SMSCK) = "1" AND IB_Amount <> BenefitAmount Then
				        smsMsg =  "--"  &IU_NICKNAME & "님 적중금 :"  & BenefitAmount & "원"
