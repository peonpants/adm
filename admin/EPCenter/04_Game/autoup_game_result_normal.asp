...
<%
    ...
    db.Open "Provider=SQLOLEDB;UID=smam;PWD=cool1004!))$;Initial Catalog=COX_C;Data Source=(local)"
    sql1="select top 300 * from info_game where (ig_status='F' or ig_status='C') AND ig_event = 'N' and (rl_sports = '야구' or rl_sports='농구' or rl_sports='아이스하키') order by ig_starttime desc"
