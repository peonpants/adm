...
<%
	...
	Call dfAccountSql.RetrieveLOG_DAILY_DATA_STAT(dfDBConn.Conn, sStartDate, sEndDate)
'dfAccountSql.debug
	...
	ALL_LDD_BATINMGM = 0
	ALL_LDD_BATOUTMGM = 0		
	ALL_LDD_BATINBACARAT = 0
	ALL_LDD_BATOUTBACARAT = 0			
...
<tr height="25" bgcolor="#EEEEEE"> 
	...
	<td align="center" >MGM홀짝배팅</td>
	<td align="center" >MGM홀짝배당</td>
	<td align="center" >MGM바카라배팅</td>
	<td align="center" >MGM바카라배당</td>
...
<tr height="25" bgcolor="<%= trBgColor %>"> 
	...
	<td align="right"><%= FormatNumber(dfAccountSql.Rs(i,"LDD_BATINLPOWER"),0) %>원</td>  
	...
	<td align="right"><%= FormatNumber(dfAccountSql.Rs(i,"LDD_BATOUTMGM"),0) %>원</td>  
	<td align="right"><%= FormatNumber(dfAccountSql.Rs(i,"LDD_BATINMGM"),0) %>원</td>  
	<td align="right"><%= FormatNumber(dfAccountSql.Rs(i,"LDD_BATOUTBACARAT"),0) %>원</td>  
	<td align="right"><%= FormatNumber(dfAccountSql.Rs(i,"LDD_BATINBACARAT"),0) %>원</td>  
...
<%
		...
		ALL_LDD_BATINPOWER =ALL_LDD_BATINPOWER + dfAccountSql.Rs(i,"LDD_BATINLPOWER")
		...
		ALL_LDD_BATINMGM =ALL_LDD_BATINMGM + dfAccountSql.Rs(i,"LDD_BATINMGM")
		ALL_LDD_BATOUTMGM =ALL_LDD_BATOUTMGM + dfAccountSql.Rs(i,"LDD_BATOUTMGM")		
		ALL_LDD_BATINBACARAT =ALL_LDD_BATINBACARAT + dfAccountSql.Rs(i,"LDD_BATINBACARAT")
		ALL_LDD_BATOUTBACARAT =ALL_LDD_BATOUTBACARAT + dfAccountSql.Rs(i,"LDD_BATOUTBACARAT")			
...
<tr height="25" style="background:#000;color:#fff"> 
	...
	<td style="background:#000;color:#fff"  align="right" ><%= FormatNumber(ALL_LDD_BATOUTMGM,0) %>원</td>  
	<td style="background:#000;color:#fff"  align="right" ><%= FormatNumber(ALL_LDD_BATINMGM,0) %>원</td> 
	<td style="background:#000;color:#fff"  align="right" ><%= FormatNumber(ALL_LDD_BATOUTBACARAT,0) %>원</td>  
	<td style="background:#000;color:#fff"  align="right" ><%= FormatNumber(ALL_LDD_BATINBACARAT,0) %>원</td> 
