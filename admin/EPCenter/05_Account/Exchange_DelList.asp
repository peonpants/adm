...
<%
	...
	Call dfAccountSql.RetrieveExchange_DelList(dfDBConn.Conn,  page, pageSize, Search, Find, sStartDate, sEndDate, site)
...
<tr>
    <td><b class="text07"> 환전 삭제 로그</b></td>
</tr>
</table>    
<div style="height:10px;"></div>

<table border="0" cellpadding="0" cellspacing="0" align="center">
<form name="MainForm" method="post" action="Exchange_delList.asp">
...
<tr <% IF IE_Status <> "1" then Response.Write "bgcolor='#f2f8f9'" Else Response.Write "bgcolor='#FFFFFF'" End IF %>>
	<td align="center"><a href="/EPCenter/02_Member/View.asp?IU_IDX=<%=IU_IDX%>&IU_SITE=<%=IE_SITE%>"><%=IE_ID%></a></td>
	<td align="center"><a href="/EPCenter/04_Game/Betting_List.asp?Search=IB_ID&Find=<%=IE_ID%>"><%=IE_NickName%></a></td>
