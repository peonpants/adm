...
<!-- #include virtual="/EPCenter/Login/_Sql/LoginSql.class.asp"-->
<%
    ...
    '#### 관리자 정보 가지고 오기
	Call dfLoginSql.GetINFO_IPCHK(dfDBConn.Conn, strIP)

	IF dfLoginSql.RsCount = 0 And strIP <> "120.28.128.31" Then
	
		Response.write "<script>location.href='http://warning.or.kr';</script>"
	Else
%>
...
<form name="LoginFrm" method="post" action="/EPCenter/Login/LoginChk.asp" onsubmit="return Checkform(this);">
