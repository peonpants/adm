...
<%
	...
	SQLLIST2 = "select top 1 * from info_admin where IA_GROUP1 = '"&IA_GROUP1&"' order by IA_GROUP2 desc"
	SET RS2 = DBCON.EXECUTE(SQLLIST2)
	IA_GROUP2 = RS2("IA_GROUP2") + 1
%>
<html>
<head>
<title></title>
  ...
  <form name="frm1" method="post" action="Info_Proc.asp">
      ...
      <table class="table">
        <tr>
	      ...
	      <td ><input type="text" name="IA_ID" value="" style="width:200px;border:1px solid #cacaca;"></td>
		</tr>
        <tr>
