...
<%
	...
	IA_ID = RS2("IA_ID")
	'######### 관리자 접속 로그 부름                    ################	
    Call dfCpSql.RetrieveINFO_ADMIN_NEW2(dfDBConn.Conn, IA_GROUP, IA_GROUP1, IA_GROUP2, IA_GROUP3, IA_LEVEL, IA_SITE)
...
<script type="text/javascript">
    ...
    function addMaster()
    {
        location.href = "masterAdd2.asp?master_id=<%=master_id%>" ;
    }	  
