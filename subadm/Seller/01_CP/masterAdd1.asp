...
<%
	...
	SQLLIST2 = "select top 1 * from info_admin where ia_site = '"&master_id&"' order by IA_GROUP2 desc"
	...
	SQLLIST2 = "select top 1 * from info_admin where IA_GROUP2 = '"&IA_GROUP2&"' order by IA_GROUP3 desc"
	SET RS2 = DBCON.EXECUTE(SQLLIST2)
	
	IA_GROUP3 = RS2("IA_GROUP3") + 1
%>
<html>
<head>
<title></title>
