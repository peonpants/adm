...
<body topmargin="15" marginheight="15">
		<div class="panel-heading" style="height:35px; padding-top:5px;"> <span style="font-size:18px; font-weight:bold;text-shadow:0px 2px 2px #fff;">게임 관리</span>
		<font color="666666">&nbsp;&nbsp;▶ 배팅 상세 - [ 아이디 : <%=IB_ID%> / 사이트명 : <%=IB_SITE%> ]</font>
		</div>
...
<table border="1" bordercolorlight="#706E6E" cellspacing="0" cellpadding="1" bordercolordark="#bebebe" width="100%">
	...
	%>
			  ...
			  <tr>
				...
				<td align="center">
								<%=left(IG_Team1,15)%><font color=red></font>
								<% if IG_Handicap <> 0 then %>
								(<font color="ff0000"><%=IG_Handicap%></font>)
								<% end if %>
								vs<font color=red></font>
								<%=left(IG_Team2,15)%><font color=red></font>
								</td>
