<%
	...
	Class gameSql
		...
		Public Function RetrieveInfo_Betting_Live2(ByRef pConn, page, pageSize,  Search, Find, sStartDate, sEndDate, site, IB_AMOUT, real_user)
                
			mDBMng.StoredProc = "dbo.UP_RetrieveInfo_Betting_live2"			
			...
			mDBMng.SetParamInt 	    8,	IB_AMOUT
			mDBMng.SetParamInt 	    9,	real_user
            RetrieveInfo_Betting_Live2 = mDBMng.Patch (pConn)
					
		End Function

        '##### 지사용 배팅 정보 리스트    ######################
        
		Public Function RetrieveInfo_Betting_sub(ByRef pConn, page, pageSize,  Search, Find, sStartDate, sEndDate, site, IB_AMOUT, real_user)
           				
			mDBMng.StoredProc = "dbo.UP_RetrieveInfo_Betting_sub1"			
			...
			mDBMng.SetParamInt 	    8,	IB_AMOUT
			mDBMng.SetParamInt 	    9,	real_user
            RetrieveInfo_Betting_sub = mDBMng.Patch (pConn)
		...
		Public Function RetrieveInfo_Betting_NEW2(ByRef pConn, page, pageSize,  Search, Find, sStartDate, sEndDate, site, IB_AMOUT, real_user,gameCode)
		...
		Public Function InsertLOG_ADMIN_CASHINOUT(ByRef pConn, IU_SITE, IA_ID, IA_CASH, IA_GCASH, IA_TYPE, LC_CONTENT, IB_IDX)
